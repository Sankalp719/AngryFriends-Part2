...
function setup(){
    ...
    box1 = new Box(1115,320,90,70);
    box2 = new Box(870,320,90,70);
    pig1 = new Pig(990, 350);
    log1 = new Log(975,260,300, PI/2);

    box3 = new Box(570,320,90,70); 
    box4 = new Box(789,320,90,70);
    pig2 = new Pig(680,350);
    log2 = new Log(680,260,300,PI/2);

   box5 = new Box(719,220,90,70);
   box6 = new Box(950,220,90,70);
   pig3 = new Pig2(835,240);
   log3 = new Log(830,190,300,PI/2);

   box7 = new Box(850,170,90,70);
   log4 = new Log(820,180,150, PI/7);
